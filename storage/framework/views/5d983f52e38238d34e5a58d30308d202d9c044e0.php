        ...
        Vue.component('checkout', {
            ...
            data: function() {
                return {
                    ...
                    country: <?php echo json_encode(core()->countries(), 15, 512) ?>,
        ...
        Vue.component('summary-section', {
            ...
            methods: {
                onSubmit: function() {
                    ...
                    axios.post('<?php echo e(route('shop.checkout.check.coupons')); ?>', {code: this_this.coupon_code})
                        .then(function(response) {
                ...
                removeCoupon: function () {
                    ...
                    axios.post('<?php echo e(route('shop.checkout.remove.coupon')); ?>')
                        .then(function(response) {
