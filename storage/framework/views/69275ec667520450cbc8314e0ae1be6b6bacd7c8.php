<?php $__env->startComponent('shop::emails.layouts.master'); ?>
    ...
    <div style="padding: 30px;">
                ...
                border-spacing: 0;width: 100%">
                    ...
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td data-value="<?php echo e(__('shop::app.customer.account.order.view.qty')); ?>" style="text-align: left;padding: 8px"><?php echo e($item->qty_canceled); ?></td>
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            ...
            <div>
                <span><?php echo e(__('shop::app.mail.order.cancel.tax')); ?></span>
                <span style="float: right;">
