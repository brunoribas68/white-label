        ...
        <div>
            ...
            <div class="product-hero-image" id="product-hero-image">
                ...
                <?php if(auth()->guard('customer')->check()): ?>
                    <a <?php if($wishListHelper->getWishlistProduct($product)): ?> class="add-to-wishlist already" <?php else: ?> class="add-to-wishlist" <?php endif; ?> href="<?php echo e(route('customer.wishlist.add', $product->product_id)); ?>">
                    </a>
                <?php endif; ?>
            </div>
