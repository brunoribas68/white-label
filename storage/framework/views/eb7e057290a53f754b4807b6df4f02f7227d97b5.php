...
<div class="layered-filter-wrapper">
    ...
    <?php echo view_render_event('bagisto.shop.products.list.layered-nagigation.before'); ?>


    <layered-navigation></layered-navigation>

    <?php echo view_render_event('bagisto.shop.products.list.layered-nagigation.after'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script type="text/x-template" id="layered-navigation-template">
        <div>
            ...
            <div class="filter-title">
                <?php echo e(__('shop::app.products.layered-nav-title')); ?>
            ...
            <div class="filter-attributes-title" @click="active = !active">
                ...
                <div class="pull-right">
                    <span class="remove-filter-link" v-if="appliedFilters.length" @click.stop="clearFilters()">
                        <?php echo e(__('shop::app.products.remove-filter-link-title')); ?>
    ...
    <script>
        Vue.component('layered-navigation', {
            ...
            data: function() {
                return {
                    attributes: <?php echo json_encode($filterAttributes, 15, 512) ?>,
                    appliedFilters: {}
                }
            },
            ...
            data: function() {
                return {
                    ...
                    sliderConfig: {
                        ...
                        max: <?php echo e(isset($category) ? core()->convertPrice($productFlatRepository->getCategoryProductMaximumPrice($category->id)) : core()->convertPrice($productFlatRepository->getProductMaximumPrice())); ?>,
                        processStyle: {
